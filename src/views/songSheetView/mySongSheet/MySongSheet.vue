    ...
    <div class="mySongSheetContainer">
            ...
            <Card >
                ...
                <template v-slot:content>
                    <div v-if="mySongSheetList.length>0">
            ...
            <MorePopUp :show="show" :title="'我的歌单'" :sheetName="sheetName" @clickMoreItem="clickMoreItem"
            :moreList="[
                {icon:'icon-zhongmingming',label:'重命名'},
        ...
        switch(label){
            ...
            case '删除':
                ...
                Dialog.confirm({
                    ...
                    .then(() => {
                        store.commit('deleteMySongSheetList',sheetName)
                    })
                    .catch(() => {
                        // on cancel
                    });
